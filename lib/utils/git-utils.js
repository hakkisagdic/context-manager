...
class GitUtils {
    ...
    async generateFromGitHub(url, options = {}) {
        ...
        const analyzer = new TokenCalculator(repoPath, {
            ...
            dashboard: true,  // Disable interactive mode for programmatic usage
            ...analyzerOptions
        });
        ...
        const formatter = new GitIngestFormatter(
            repoPath,
            results,           // Contains stats
            results.files,     // Array of file analysis results
