...
node test/test-llm-detector-extended.js > /dev/null 2>&1
...
node test/test-git-utils-extended.js > /dev/null 2>&1
...
node test/test-token-calculator-reports.js > /dev/null 2>&1
...
node test/test-incremental-analyzer-extended.js > /dev/null 2>&1
...
node test/test-toon-decoder.js > /dev/null 2>&1
